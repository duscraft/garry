...
import { LogOut, Plus, Shield, Grid, Menu, X } from 'lucide-react';
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <Link to="/" className="flex-shrink-0 flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Garry</span>
            </Link>
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            ...
            <div className="ml-3 relative flex items-center">
              ...
              <button
                onClick={() => logout()}
                className="bg-white p-1 rounded-full text-gray-400 hover:text-gray-600 focus:outline-none"
